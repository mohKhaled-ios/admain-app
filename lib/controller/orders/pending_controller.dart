...
class OrdersPendingController extends GetxController {
  OrderpendingData ordersPendingData = OrderpendingData(Get.find());
  ...
  getOrders() async {
    ...
    update();
    var response = await ordersPendingData.pendingData();
  ...
  approveorder(String userid, String orderid) async {
    ...
    statusRequest = StatusRequest.loading;
    update();
    var response = await ordersPendingData.approveData(orderid, userid);
    print("=============================== Controller $response ");
    statusRequest = handlingData(response);
    if (StatusRequest.success == statusRequest) {
      // Start backend
